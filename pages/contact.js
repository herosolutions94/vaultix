    ...
    <div className="contact_page">
      ...
      <section className="ct_hero">
        <div className="pg_contain">
          ...
          <h1>Secure Communication with<br />Verified Support</h1>
          <p>All communication is encrypted and processed through verified institutional support channels with strict security protocols.</p>
          <div className="ct_hero_btns">
            <a href="#form" className="btn_gold">Submit Secure Request</a>
            <Link href="/security" className="btn_ghost">View Security Guidelines</Link>
          </div>
        </div>
      </section>
                ...
                <form className="ct_form" onSubmit={(e) => e.preventDefault()}>
                  <div className="ct_form_grid">
                    <div className="ct_field">
                      ...
                      <input type="text" placeholder="As it appears on your verified ID" />
                    </div>
                    <div className="ct_field">
                      <label>Verified Email Address</label>
                      <input type="email" placeholder="Institutional email preferred" />
                    </div>
                    <div className="ct_field">
                      <label>Vault ID <span className="ct_optional">(Optional)</span></label>
                    ...
                    <div className="ct_field">
                      ...
                      <div className="ct_select_wrap">
                        ...
                        <svg className="ct_chevron" width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round"><polyline points="6 9 12 15 18 9"/></svg>
                      </div>
                    </div>
                    <div className="ct_field ct_field_full">
                      <label>Secure Message</label>
                      <textarea rows={5} placeholder="Detail your request securely. Do not include sensitive key phrases here." />
                    </div>
                  </div>

                  <div className="ct_form_footer">
                    <p className="ct_disclaimer">By submitting, you agree to our strict security protocols. Identity verification may be required before processing.</p>
                    <button type="submit" className="btn_gold ct_submit_btn">Transmit Securely</button>
                  </div>
                </form>
              </div>
            </div>
              ...
              <div className="ct_info_card">
                ...
                <div className="ct_categories">
                  {CATEGORIES.map((cat) => (
                    <div className="ct_cat_item" key={cat.title}>
                      <img src={cat.icon} alt={cat.title} className="ct_cat_icon" />
                ...
                <div className="ct_response">
                  ...
                  <div className="ct_response_row">
                    ...
                    <span className="ct_response_val ct_val_gold">&lt; 24 Hours</span>
                  </div>
                  <div className="ct_response_row">
                    <span className="ct_response_type">
                      <svg width="13" height="13" viewBox="0 0 24 24" fill="#E9C176" stroke="#E9C176" strokeWidth="0"><path d="M10.29 3.86L1.82 18a2 2 0 0 0 1.71 3h16.94a2 2 0 0 0 1.71-3L13.71 3.86a2 2 0 0 0-3.42 0z"/><line x1="12" y1="9" x2="12" y2="13" stroke="white" strokeWidth="2" strokeLinecap="round"/><line x1="12" y1="17" x2="12.01" y2="17" stroke="white" strokeWidth="2" strokeLinecap="round"/></svg>
                      Security Critical
                    </span>
                    <span className="ct_response_val ct_val_teal">Immediate Priority</span>
                  </div>
                </div>
              </div>
            </div>
          ...
          <div className="ct_channels_wrap">
            ...
            <div className="ct_channel_card ct_card_teal">
              <div className="ct_channel_head">
                <img src="/images/front-images/mail.png" alt="Mail" className="ct_ch_icon" />
                <span className="ct_ch_badge ct_badge_active">Active</span>
              </div>
              <h3>Secure Mail</h3>
              <p>Encrypted asynchronous communication for non-critical institutional inquiries.</p>
              <a href="mailto:support@vaultix.io" className="ct_ch_link">support@vaultix.io</a>
            </div>

            {/* Global Presence */}
            <div className="ct_channel_card">
              <div className="ct_channel_head">
                <img src="/images/front-images/location.png" alt="Location" className="ct_ch_icon" />
                <span className="ct_ch_badge ct_badge_vaults">Vaults</span>
              </div>
              <h3>Global Presence</h3>
              <p>Physical Vault Locations for deep-storage audit and custodial handovers.</p>
