...
const ColCheck = ({ val }) => {
  ...
  if (val && typeof val === "object" && val.gold)
    return <span className="pr_text_gold">{val.val}</span>;
        ...
        <div className="pg_contain">
          <div className="pr_hero_wrap">
            <div className="pr_hero_left">
              ...
              <h1>
                Secure Digital Legacy with Institutional-Grade Protection.
              </h1>
              <p>
                Our pricing reflects the uncompromising architecture required to
                maintain absolute cryptographic certainty over your most
                critical assets. Zero-knowledge by design.
              </p>
            </div>
            <div className="pr_hero_right">
              <img
                src="/images/front-images/pricing-hero.png"
                alt="Vaultix Security"
              />
            </div>
          </div>
        </div>
      ...
      <section className="pr_plans">
        <div className="pg_contain">
          <div className="sec_head">
            ...
            <p>
              Select the security posture that aligns with your digital asset
              profile.
            </p>
          </div>
      ...
      <section className="pr_compare">
        <div className="pg_contain">
          <div className="sec_head">
            ...
            <p>
              Detailed specifications of our cryptographic protocols and custody
