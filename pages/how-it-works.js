...
export default function HowItWorks({ result }) {
  const {
    page_title,
    meta_desc,
    content,
  ...
  console.log("all_phases", all_phases);

  const OVERVIEW_STEPS = [1, 2, 3, 4, 5]
    .map((i) => ({
      ...
      <div className="hiw_page">
        ...
        <section className="hiw_hero">
          <div className="pg_contain">
            <div className="hiw_badge">{content?.banner_title}</div>
            <h1>
        ...
        <div className="hiw_phases">
          {all_phases?.map((phase, i) => {
            const isEven = i % 2 === 0;

            return (
              <section key={phase?.id} className="hiw_phase">
                <div className="pg_contain">
                  <div
                    className="hiw_phase_wrap"
                    style={{
                      display: "flex",
                  ...
                  >
                    ...
                    <div className="hiw_phase_img">
                      <img
                        src={cmsFileUrl(phase?.image, "images")}
                        alt={phase?.title}
                      />
                    </div>
                    ...
                    <div className="hiw_phase_text">
                      <span className="hiw_phase_label">
                        Phase {String(i + 1).padStart(2, "0")}
                      </span>

                      <h3>{phase?.title}</h3>

                      <Text string={phase?.txt1} />
                    </div>
                  </div>
                </div>
              </section>
        ...
        {/* <section className="hiw_phase">
          <div className="pg_contain">
            <div className="hiw_phase_wrap hiw_img_left">
              <div className="hiw_phase_img">
                <img
                  src="/images/front-images/work-1.png"
                  alt="Store Encrypted Assets"
                />
              </div>
              ...
              <div className="hiw_phase_text">
                ...
                <p className="hiw_phase_desc">
                  Secure your critical data in a military-grade digital vault.
                  Centralize and secure your most critical digital wealth and
                  documentation within our impenetrable zero-knowledge
                  architecture.
                </p>
                ...
                <div className="hiw_quote_box">
                  ...
                  <p>
                    "All vault data is encrypted before storage and remains
                    unreadable through zero-knowledge architecture. Not even
                    Vaultix can access your asset."
                  </p>
                </div>
              </div>
            </div>
          ...
          <div className="pg_contain">
            <div className="hiw_phase_wrap hiw_img_right">
              <div className="hiw_phase_text">
                ...
                <p className="hiw_phase_desc">
                  Set precise inactivity triggers and check-in schedules to
                  establish a robust dead-man's switch tailored to your specific
              ...
              <div className="hiw_phase_img">
                <img
                  src="/images/front-images/work-2.jpg"
                  alt="Configure Monitoring"
                />
              </div>
            </div>
          </div>
        ...
        {/* <section className="hiw_phase">
          <div className="pg_contain">
            <div className="hiw_phase_wrap hiw_img_left">
              <div className="hiw_phase_img">
                <img
                  src="/images/front-images/work-3.png"
              ...
              <div className="hiw_phase_text">
                ...
                <p className="hiw_phase_desc">
                  Multi-layered confirmation protocols ensure accuracy. Our
                  system employs continuous identity confirmation to prevent
                  accidental triggers.
                </p>
                <div className="hiw_feats">
                  <IconFeature
          ...
          <div className="pg_contain">
            <div className="hiw_phase_wrap hiw_img_right">
              <div className="hiw_phase_text">
                ...
                <p className="hiw_phase_desc">
                  Protected release sequences initiate upon verified conditions,
                  shifting the protocol from holding to active execution while
                  maintaining absolute cryptographic integrity.
                </p>
                <div className="hiw_feats">
                  <IconFeature
                    icon={
              ...
              <div className="hiw_phase_img">
                <img
                  src="/images/front-images/work-4.png"
                  alt="Beneficiary Activation"
                />
              </div>
            </div>
          </div>
        ...
        {/* <section className="hiw_phase">
          <div className="pg_contain">
            <div className="hiw_phase_wrap hiw_img_left">
              <div className="hiw_phase_img">
                <img
                  src="/images/front-images/work-5.png"
                  alt="Secure Legacy Transfer"
                />
              </div>
              ...
              <div className="hiw_phase_text">
                ...
                <p className="hiw_phase_desc">
                  End-to-end encrypted delivery of assets to designated heirs.
                  The final phase executes the precise release of information to
                  authorized beneficiaries through secure, ephemeral channels.
                </p>
