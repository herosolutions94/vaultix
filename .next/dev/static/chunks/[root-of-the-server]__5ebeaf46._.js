...
"[project]/pages/dashboard/vault/categories/add-category.js [client] (ecmascript)", ((__turbopack_context__, module, exports) => {

const e = new Error("Could not parse module '[project]/pages/dashboard/vault/categories/add-category.js', file not found");
e.code = 'MODULE_UNPARSABLE';
throw e;
}),
"[next]/entry/page-loader.ts { PAGE => \"[project]/pages/dashboard/vault/categories/add-category.js [client] (ecmascript)\" } [client] (ecmascript)", ((__turbopack_context__, module, exports) => {

const PAGE_PATH = "/dashboard/vault/categories/add-category";
(window.__NEXT_P = window.__NEXT_P || []).push([
    PAGE_PATH,
    ()=>{
        return __turbopack_context__.r("[project]/pages/dashboard/vault/categories/add-category.js [client] (ecmascript)");
    }
]);
...
"[hmr-entry]/hmr-entry.js { ENTRY => \"[project]/pages/dashboard/vault/categories/add-category.js\" }", ((__turbopack_context__) => {
"use strict";

__turbopack_context__.r("[next]/entry/page-loader.ts { PAGE => \"[project]/pages/dashboard/vault/categories/add-category.js [client] (ecmascript)\" } [client] (ecmascript)");
}),
]);

//# sourceMappingURL=%5Broot-of-the-server%5D__5ebeaf46._.js.map